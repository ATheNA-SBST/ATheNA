...
%% Toggles
warnOn = false;
assignin('base','warnOn',warnOn)

%% Set Initial Conditions
scenario = 'GCAS'; %'u_turn';
...
assignin('base','GCAS_starts_on',GCAS_starts_on)
...
assignin('base','SIM_config',SIM_config)